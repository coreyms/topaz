---------------------------------------------------------------------------------------------------
-- func: despawn a mob
-- desc: like the func line wasn't enough.
-- revised by: fishy
---------------------------------------------------------------------------------------------------
...
cmdprops =
{
  ...
  -- local kspawn1 = DespawnMob(17408018);
	--local kspawn2 = DespawnMob(17408019);
--	local kspawn3 = DespawnMob(17297440);
--	local kspawn4 = DespawnMob(17297441);
--	local kspawn5 = DespawnMob(17301537);
--	local kspawn6 = DespawnMob(17301538);
--	local kspawn7 = DespawnMob(17027458);
--	local kspawn8 = DespawnMob(17101201);
